...
Software engineer, SRE, Principal SWE, Linux engineer with 42 years of
infrastructure building, prolific application and tool developer, and technical
hobbyist.
...
```mermaid
graph TD
    profile["Kevin P. Inscoe"]
    profile --> c0["Compute Infrastructure and Site Reliability Engineering"]
    c0 --> c0s0["AWS"]
    c0 --> c0s1["Azure"]
    c0 --> c0s2["Kubernetes"]
    c0 --> c0s3["Infrastructure as Code (IaC)"]
    c0 --> c0s4["Observability"]
    c0 --> c0s5["Operational tooling"]
    profile --> c1["Playbooks and Skill Demonstration"]
    c1 --> c1s0["Playbooks"]
    c1 --> c1s1["Example code"]
    profile --> c2["Proof of Concept and Moonshot Projects"]
    c2 --> c2s0["Proof of concept"]
    c2 --> c2s1["Moonshot projects"]
    profile --> c3["Software Development"]
    c3 --> c3s0["Go"]
    c3 --> c3s1["Python"]
